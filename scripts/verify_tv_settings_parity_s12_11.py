...
require("target version name", 'versionName = "0.57.10-tv-cleanroom-s12.11-settings-parity"' in gradle)
require("target version code", "versionCode = 133" in gradle)
require("seven TV categories", len(re.findall(r'^    [A-Z_]+\("', models, re.MULTILINE)) == 7)
